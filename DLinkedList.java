...
class DLinkedList {  // methods for Doubly Linked List
    Node head;

    public void insert(String itmno, String itmdesc, String qty, double uprice, double disc) { // insert new item
    ...
    public void delete(String itmno) { // delete item
        if (head == null) {
